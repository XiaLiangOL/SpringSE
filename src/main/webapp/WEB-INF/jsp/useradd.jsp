...
<div class="right">
        ...
        <div class="providerAdd">
            <form id="userForm" name="user" method="post" action="${pageContext.request.contextPath }/user/adduser.html">
                <!--div的class 为error是验证错误，ok是验证成功  enctype="multipart/form-data"-->
                <div>
